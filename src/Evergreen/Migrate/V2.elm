...
migrate_Types_FrontendMsg old =
    case old of
        ...
        Evergreen.V1.Types.SelectCell p0 p1 ->
            Evergreen.V2.Types.SelectCell p0 p1

        Evergreen.V1.Types.InputDigit p0 ->
            Evergreen.V2.Types.InputDigit p0

        Evergreen.V1.Types.KeyPressed p0 ->
            Evergreen.V2.Types.KeyPressed p0


migrate_Types_ToBackend : Evergreen.V1.Types.ToBackend -> Evergreen.V2.Types.ToBackend
migrate_Types_ToBackend old =
    case old of
        Evergreen.V1.Types.UpdateCell p0 p1 p2 ->
            Evergreen.V2.Types.UpdateCell p0 p1 p2
